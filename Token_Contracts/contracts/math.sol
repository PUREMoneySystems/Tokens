library math {
    ...
    function log2Floor(uint256 value) returns (uint8 exponent){
        return logFloor(value, 2);
    }
    
    function log2Ceiling(uint256 value) returns (uint8 exponent){
        return logCeiling(value, 2);
    }
    
    function log10Floor(uint256 value) returns (uint8 exponent){
      return logFloor(value, 10);
    }
    
    function log10Ceiling(uint256 value) returns (uint8 exponent){
      return logCeiling(value, 10);
    }
    
    
    function logFloor(uint256 value, uint8 base) returns (uint8 exponent){
      while((value /= base) > 0){
	        exponent++;
      }
      return exponent;
    ...
    function logCeiling(uint256 value, uint8 base) returns (uint8 exponent){
